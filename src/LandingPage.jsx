...
export default function LandingPage() {
    return (
        <div className="min-h-screen bg-[#F4F4F0] text-black font-sans selection:bg-[#FFDE4D] overflow-x-hidden p-4 md:p-8">
            ...
            {/* ─── 🍱 BENTO FEATURE GRID (VERSI FIX & BERSIH MURNI) ─── */}
            <main className="max-w-7xl mx-auto mb-24">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[220px_md:260px]">
                    ...
                    <div className="bg-white border-4 border-black p-6 rounded-2xl shadow-[6px_6px_0px_0px_#000] md:col-span-2 md:row-span-2 flex flex-col justify-between overflow-hidden relative group transition-transform duration-300 hover:scale-[1.01]">
                        <div>
                        ...
                        <div className="bg-[#F4F4F0] border-2 border-black rounded-xl p-3 shadow-[3px_3px_0px_0px_#000] flex flex-col gap-2 font-mono text-xs md:text-sm">
                            <div className="flex justify-between items-center">
                                ...
                                <span className="text-red-500 font-bold animate-pulse">● Live Chat</span>
                            </div>
                    ...
                    {/* Box 2: Real-time Database (Satu Box Tunggal - Sudah Di-refactor) */}
                    ...
                    {/* Box 3: Dompet Bersama / Shared Wallet (Satu Box Tunggal) */}
                    <div className="bg-[#4D96FF] text-white border-4 border-black p-6 rounded-2xl shadow-[6px_6px_0px_0px_#000] flex flex-col justify-between transition-transform duration-300 hover:rotate-[-1deg]">
                        <div className="text-3xl">👥</div>
                        <div>
                            ...
                            <p className="font-bold text-sm text-white/90 mt-1">
                                Kelola budget kolaboratif bersama partner atau tim. Cukup hubungkan akun melalui bot Telegram untuk membagi akses dompet secara instan.
                            </p>
                        </div>
                    </div>

                    {/* Box 4: Passwordless Magic Link (Makan 2 Kolom di Desktop) */}
                    <div className="bg-[#FF6B6B] text-white border-4 border-black p-6 rounded-2xl shadow-[6px_6px_0px_0px_#000] md:col-span-2 flex flex-col justify-between relative overflow-hidden transition-transform duration-300 hover:translate-y-[-2px]">
                        ...
                        <div>
                            ...
                            <p className="font-bold text-sm md:text-base text-white/90 mt-1 max-w-xl">
                                Keamanan tingkat tinggi tanpa repot menghafal password. Masuk ke Web Dashboard secara instan melalui enkripsi token aman sekali pakai yang dikirim langsung ke Telegram kamu.
                            </p>
                        </div>
                    </div>

                    {/* Box 5: Visualisasi Bento UI (Makan 1 Kolom Tinggi di Desktop) */}
                    <div className="bg-white border-4 border-black p-6 rounded-2xl shadow-[6px_6px_0px_0px_#000] md:row-span-2 flex flex-col justify-between transition-transform duration-300 hover:scale-[0.99]">
                        <div>
                            <div className="text-3xl">📊</div>
                            ...
                            <p className="font-bold text-sm text-gray-600 mt-1">
                                Visualisasi data keuangan yang dikemas ke dalam layout bento grid modern. Analisis pengeluaran jadi lebih intuitif, interaktif, dan rapi.
                            </p>
                        </div>
                        {/* Grafik Mini Pelengkap Visual */}
                        <div className="grid grid-cols-2 gap-2 mt-4">
                            <div className="h-12 bg-[#6BCB77] border-2 border-black rounded-lg shadow-[2px_2px_0px_0px_#000] flex items-center justify-center font-black text-xs text-white">INCOME</div>
                            <div className="h-12 bg-[#FF6B6B] border-2 border-black rounded-lg shadow-[2px_2px_0px_0px_#000] flex items-center justify-center font-black text-xs text-white">EXPENSE</div>
                        </div>
                    </div>
